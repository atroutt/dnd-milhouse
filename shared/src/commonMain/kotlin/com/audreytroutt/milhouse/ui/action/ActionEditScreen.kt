...
fun ActionEditScreen(
    ...
    actionId: Long?,
    onNavigateBack: () -> Unit,
    viewModel: ActionViewModel = koinViewModel(key = "action-$characterId") { parametersOf(characterId) }
) {
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                value = name, onValueChange = { name = it }, label = { Text("Action Name *") },
                modifier = Modifier.fillMaxWidth(), singleLine = true,
                keyboardOptions = KeyboardOptions(capitalization = KeyboardCapitalization.Sentences)
            )

            DropdownField(label = "Action Type", value = actionType, options = ACTION_TYPES, onValueChange = { actionType = it })
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                OutlinedTextField(
                    value = damage, onValueChange = { damage = it }, label = { Text("Damage Dice") },
                    placeholder = { Text("e.g. 2d6") }, modifier = Modifier.weight(1f), singleLine = true,
                    keyboardOptions = KeyboardOptions(capitalization = KeyboardCapitalization.Sentences)
                )
                DropdownField(
                    label = "Damage Type",
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                OutlinedTextField(
                    value = toHit, onValueChange = { toHit = it }, label = { Text("To Hit Bonus") },
                    placeholder = { Text("e.g. +5") }, modifier = Modifier.weight(1f), singleLine = true,
                    keyboardOptions = KeyboardOptions(capitalization = KeyboardCapitalization.Sentences)
                )
                OutlinedTextField(
                    value = range, onValueChange = { range = it }, label = { Text("Range") },
            ...
            OutlinedTextField(
                value = savingThrow, onValueChange = { savingThrow = it }, label = { Text("Saving Throw") },
                placeholder = { Text("e.g. DC 14 DEX") }, modifier = Modifier.fillMaxWidth(), singleLine = true,
                keyboardOptions = KeyboardOptions(capitalization = KeyboardCapitalization.Sentences)
            )
        }
    }
