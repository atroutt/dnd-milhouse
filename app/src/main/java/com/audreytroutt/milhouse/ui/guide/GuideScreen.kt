    ...
    Scaffold(
        ...
        Column(
            ...
            GuideSection(title = "Spells — \"To Hit\" vs. \"Save DC\"") {
                ...
                GuideEntry(
                    heading = "\"The target must make a [Stat] saving throw\"",
                    body = null
                )
                BulletList(
                    items = listOf(
            ...
            GuideSection(title = "Common Confusion") {
                GuideEntry(
                    heading = "DC vs. AC — what's the difference?",
                    body = null
                )
                BulletList(
                    items = listOf(
                ...
                GuideEntry(
                    heading = "Ability Check vs. Saving Throw",
                    body = null
                )
                BulletList(
                    items = listOf(
